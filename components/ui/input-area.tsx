                            ...
                            {value.trim() ? (
                                ...
                                >
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-accent-green/10 text-accent-green hover:bg-accent-green/20 transition-colors text-sm font-medium border border-accent-green/20 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                                        title="Save as Note"
                                        disabled={isLoading}
