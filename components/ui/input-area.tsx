                            ...
                            {value.trim() ? (
                                ...
                                >
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-4 py-2.5 rounded-full bg-accent-green/10 text-accent-green hover:bg-accent-green/20 transition-colors text-sm font-medium border border-accent-green/20 disabled:opacity-50 disabled:cursor-not-allowed"
                                        title="Save as Note"
                                        disabled={isLoading}
                                    ...
                                    <button
                                        ...
                                        className="flex items-center gap-2 px-5 py-2.5 rounded-full bg-primary text-white shadow-lg shadow-primary/30 hover:scale-105 active:scale-95 transition-all text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                                        title="Ask AI"
                                        disabled={isLoading}
                                        aria-label="Ask AI"
                                    >
